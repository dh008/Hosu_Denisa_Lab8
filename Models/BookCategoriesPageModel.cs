...
namespace Hosu_Denisa_Lab8.Models
{
    public class BookCategoriesPageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Hosu_Denisa_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Hosu_Denisa_Lab8Context context,
